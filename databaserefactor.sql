...
VALUES ('Joe''s Diner', '123 Main St', 'Fargo', 'ND', '12345'),
		...
		('Sam''s Grocery', '12 3rd Ave', 'Moorhead', 'MN', '24680'),
		...
		('Joe''s Pizzeria', '123 Main St', 'Bismarck', 'ND', '10001'),
		('Smith and Co', '456 1st Ave', 'Bismarck', 'MN', '10003'),
		('Tom''s Diner', '789 2nd St', 'Bismarck', 'ND', '10002'),
		('Mary''s Beauty Salon', '321 3rd Ave', 'Fargo', 'ND', '10003'),
		('Mike''s Garage', '654 4th St', 'Fargo', 'ND', '10004'),
		('Bill''s Bar', '987 5th Ave', 'Fargo', 'ND', '10005'),
		('John''s Plumbing', '741 6th St', 'Moorhead', 'MN', '10006'),
		('Susan''s Bookstore', '852 7th Ave', 'Moorhead', 'MN', '10007'),
		('Larry''s Bakery', '963 8th Ave', 'Ada', 'MN', '10008'),
		('Carol''s Restaurant', '753 9th ave', 'Ada', 'MN', '10009');
