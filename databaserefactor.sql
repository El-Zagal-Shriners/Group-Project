...
VALUES (random() * 19 + 1,'10% off',NULL,NULL,'Present your ID',random() * 8 + 1),
		(random() * 19 + 1,'15% off',NULL,NULL,'Sdgljner425',random() * 8 + 1),
		(random() * 19 + 1,'20% off',NULL,NULL,'Mention Shriner',random() * 8 + 1),
		(random() * 19 + 1,'BOGO Wings',NULL,NULL,'3gh456herwg',random() * 8 + 1),
		(random() * 19 + 1,'BOGO Beer',NULL,NULL,'BOGOBEER',random() * 8 + 1),
		(random() * 19 + 1,'BOGO 50% off',NULL,NULL,'50 Off',random() * 8 + 1),
		(random() * 19 + 1,'10% off',NULL,NULL,'Present ID',random() * 8 + 1),
		(random() * 19 + 1,'15% off',NULL,NULL,'Sdgljner425',random() * 8 + 1),
		(random() * 19 + 1,'20% off',NULL,NULL,'Mention Shriner',random() * 8 + 1),
		(random() * 19 + 1,'BOGO Wings',NULL,NULL,'3gh456herwg',random() * 8 + 1),
		(random() * 19 + 1,'BOGO Beer',NULL,NULL,'BOGOBEER',random() * 8 + 1),
